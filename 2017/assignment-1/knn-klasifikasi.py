...
def main():
	...
	#Load Dataset
   	loadDataset('5115100043_pima-indians-diabetes.data', split, trainingSet, testSet)
	...
	for x in range(len(testSet)):
		neighbors = getNeighbors(trainingSet, testSet[x], k, pilih) # Cari k-data terdekat
	...
	print('Accuracy: ' + repr(accuracy) + '%') # Hitung berapa akurasinya
